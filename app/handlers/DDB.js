...
var U = mongoose.model('U', UserSchema,'Bank');

function DraftBank (req,res){
  U.find({"status":"A","bankCashFlag": "B"},null,{limit:100},function (error, data) {
...
exports.DraftBank = DraftBank;


// function DraftBank (req,res){
// var DraftBank=model.find({ "status": "A", "bankCashFlag": "B" }, {_id: 0}, function (error, data) {
//         if(error) {
